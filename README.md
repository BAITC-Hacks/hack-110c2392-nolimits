...
5. Раздел **«Data editor»** — создание и редактирование товаров, поставщиков, продаж, остатков, поставок в пути и stockout-периодов без Excel. Форма автоматически сохраняет незавершённую строку в SQLite-черновик и восстанавливает её после перезапуска.
