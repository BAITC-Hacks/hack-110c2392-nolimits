...
export default function App() {
  ...
  const ekt = async () => { setBusy(true); try { await loadEkt(); await refresh(); showToast('⚡️ Синтетический EKT-кейс загружен и рассчитан') } catch (error) { showToast(error instanceof Error ? error.message : 'Could not load ekt.kz data') } finally { setBusy(false) } }
