...
import { Badge, BrandMark, Icon, Modal, number, warehouseName } from './ui'
...
export default function App() {
  ...
  return <div className={`app-shell ${collapsed ? 'sidebar-collapsed' : ''}`}>
    ...
    {mobileNav && <Modal title="Basqar" icon={<BrandMark decorative/>} className="navigation-drawer" onClose={() => setMobileNav(false)}>{navigation}</Modal>}
